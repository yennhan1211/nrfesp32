...
// Feature Register
enum {
	nRF24_EN_DYN_ACK  = (uint8_t)0x00, // Enables the W_TX_PAYLOAD_NOACK command
	nRF24_EN_ACK_PAY  = (uint8_t)0x01, // Enables Payload with ACK
	nRF24_EN_DPL      = (uint8_t)0x02, // Enables Dynamic Payload Length
};
...
/*
  // If use Ack payload, programmer always will have to update Ack data after transmit ack.
  // Because Ack Fifo will be flush after ack trasmitted.
*/
